...
class HomeViewController: UIViewController {
    ...
    private func configureHeroHeaderView() {
        ...
        APICalller.shared.getTrendingMovies { [weak self] result in
            switch result {
...
extension HomeViewController : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case Sections.TrendingMovies.rawValue:
            ...
            APICalller.shared.getTrendingMovies { result in
                switch result {
                case .success(let titles):
        ...
        case Sections.TrendingTv.rawValue:
            ...
            APICalller.shared.getTrendingTvs { result in
                switch result {
                case .success(let titles):
                    cell.configure(with: titles)
                case .failure(let error):
        ...
        case Sections.Popular.rawValue:
            ...
            APICalller.shared.getPopular { result in
                switch result {
                case .success(let titles):
                    cell.configure(with: titles)
                case .failure(let error):
        ...
        case Sections.Upcoming.rawValue:
            ...
            APICalller.shared.getUpcomingMovies { result in
                switch result {
                case .success(let titles):
                    cell.configure(with: titles)
                case .failure(let error):
        ...
        case Sections.TopRated.rawValue:
            ...
            APICalller.shared.getTopRated { result in
                switch result {
                case .success(let titles):
                    cell.configure(with: titles)
                case .failure(let error):
